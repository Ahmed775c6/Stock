      ...
      <section class="w-full flex flex-col min-h-screen">
        ...
        <div class="w-full h-full p-4 md:p-8 overflow-y-auto">
          ...
          <Show when={!loading() && invoiceData()}>
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 print:shadow-none">
              {/* Print Button */}
              <div class="flex justify-end mb-6 gap-3 print:hidden">
                <A href = {"/factures"} class=" bg-gray-200 text-gray-900 dark:bg-gray-600 px-4 py-2 rounded-lg  dark:text-white">Retour</A>
                <button
                  onClick={handlePrint}
              ...
              {/* Invoice Header */}
              <div class="flex flex-col md:flex-row justify-between items-start mb-8 pb-6 border-b border-gray-200 dark:border-gray-700">
                <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  <h3 class="text-lg font-semibold text-blue-800 dark:text-blue-200">Total Facturé</h3>
                  <p class="text-2xl font-bold text-blue-900 dark:text-blue-100">
                    {formatCurrency(invoiceData()?.total || 0)}
                  </p>
                </div>
                <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <h3 class="text-lg font-semibold text-green-800 dark:text-green-200">Payé</h3>
                  <p class="text-2xl font-bold text-green-900 dark:text-green-100">
                    {formatCurrency(invoiceData()?.paid_total || 0)}
                  </p>
                </div>
                <div class="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
                  <h3 class="text-lg font-semibold text-amber-800 dark:text-amber-200">En Attente</h3>
                ...
                <div class="overflow-x-auto">
                  <table class="w-full">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                      <tr>
                        <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                          Date
                        </th>
                        <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                          Produit
                        ...
                        <th class="py-3 px-4 text-right text-sm font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                          Total
                        </th>
                      </tr>
                    </thead>
                      ...
                      <For each={invoiceData()?.items}>
                        {(item) => (
                          <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <td class="py-3 px-4 text-sm font-semibold text-gray-900 dark:text-white text-right">
                    ...
                    <tfoot class="bg-gray-50 dark:bg-gray-700">
                      <tr>
                        <td colspan="5" class="py-3 px-4 text-sm font-medium text-gray-900 dark:text-white text-right">
                          Total Général:
                        </td>
                        <td class="py-3 px-4 text-sm font-bold text-gray-900 dark:text-white text-right">
                          {formatCurrency(invoiceData()?.total || 0)}
                        </td>
                      </tr>
                    </tfoot>
